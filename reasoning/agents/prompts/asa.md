...
{ 
  ...
  "buses": "int[] (the IDs of every bus which you have allocated to the trip. This should be empty if the allocation request is to be ignored or the service cancelled)",
  "cancel": "bool (true if the service should be cancelled)",
  "rationale": "A brief rationale for your decision.",
  "report": "string | null (optional message to the Central Reasoning Agent)",
